...
# - SFML_BINARIES:     the list of all binaries corresponding to the required modules
...
foreach(FIND_SFML_COMPONENT ${SFML_FIND_COMPONENTS})
    ...
    if(FIND_SFML_COMPONENT_LOWER STREQUAL "main")
        ...
        if (WIN32)
            # DLL release
            find_file(SFML_${FIND_SFML_COMPONENT_UPPER}_BINARY_RELEASE
                      NAMES ${FIND_SFML_COMPONENT_NAME}-2.dll
                      HINTS ${FIND_SFML_PATHS}
                      PATH_SUFFIXES "" bin Release RelWithDebInfo MinSizeRel)
            
            # DLL debug
            find_file(SFML_${FIND_SFML_COMPONENT_UPPER}_BINARY_DEBUG
                      NAMES ${FIND_SFML_COMPONENT_NAME}-d-2.dll
                      HINTS ${FIND_SFML_PATHS}
    ...
    MARK_AS_ADVANCED(SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY
                     ...
                     SFML_${FIND_SFML_COMPONENT_UPPER}_BINARY_RELEASE
                     SFML_${FIND_SFML_COMPONENT_UPPER}_BINARY_DEBUG)

    # add to the global list of libraries
    set(SFML_LIBRARIES ${SFML_LIBRARIES} "${SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY}")
    set(SFML_BINARIES ${SFML_BINARIES} ${SFML_${FIND_SFML_COMPONENT_UPPER}_BINARY_RELEASE} ${SFML_${FIND_SFML_COMPONENT_UPPER}_BINARY_DEBUG})
endforeach()
